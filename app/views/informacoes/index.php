    ...
    <main class="conteudo">
        ...
        <section>
            ...
            <table class="tabela-materiais">
                ...
                <tbody>
                    <tr>
                        <td data-label="Nome do Material">Celulares e Tablets</td>
                        <td data-label="Descrição">Dispositivos móveis que contêm metais preciosos, plásticos e baterias.</td>
                        <td data-label="Observações para Descarte">Remova chips e cartões de memória. Apague todos os dados pessoais. Descarte a bateria separadamente, se possível.</td>
                        <td data-label="Exemplos de Itens">Smartphones, feature phones, tablets, e-readers.</td>
                        <td data-label="Riscos do Descarte Incorreto">Contaminação do solo e água por chumbo, cádmio, mercúrio; perda de dados pessoais.</td>
                        <td data-label="Benefícios da Reciclagem">Recuperação de ouro, prata, cobre, platina; redução da mineração; prevenção da poluição.</td>
                    </tr>
                    <tr>
                        <td data-label="Nome do Material">Notebooks e Desktops</td>
                        <td data-label="Descrição">Computadores portáteis e de mesa, ricos em diversos componentes recicláveis.</td>
                        <td data-label="Observações para Descarte">Apague todos os dados do disco rígido. Remova baterias e fontes de alimentação, se possível.</td>
                        <td data-label="Exemplos de Itens">Laptops, netbooks, ultrabooks, PCs de mesa.</td>
                        <td data-label="Riscos do Descarte Incorreto">Liberação de substâncias tóxicas como chumbo e mercúrio; vazamento de informações.</td>
                        <td data-label="Benefícios da Reciclagem">Reaproveitamento de metais, plásticos e vidros; economia de energia e recursos naturais.</td>
                    </tr>
                    <tr>
                        <td data-label="Nome do Material">Fios e Cabos</td>
                        <td data-label="Descrição">Cabos de energia, dados, áudio e vídeo, contendo principalmente cobre e plástico.</td>
                        <td data-label="Observações para Descarte">Separe os cabos de outros eletrônicos. Não é necessário remover as capas plásticas.</td>
                        <td data-label="Exemplos de Itens">Cabos USB, HDMI, de força, de rede, carregadores.</td>
                        <td data-label="Riscos do Descarte Incorreto">Desperdício de cobre, um metal valioso; poluição por plásticos não biodegradáveis.</td>
                        <td data-label="Benefícios da Reciclagem">Recuperação de cobre de alta pureza; redução da produção de plástico virgem.</td>
                    </tr>
                    <tr>
                        <td data-label="Nome do Material">Pilhas e Baterias</td>
                        <td data-label="Descrição">Baterias de diferentes tipos, com alto teor de metais pesados.</td>
                        <td data-label="Observações para Descarte">Nunca jogue no lixo comum. Procure pontos de coleta específicos para pilhas e baterias.</td>
                        <td data-label="Exemplos de Itens">Pilhas AA, AAA, C, D, 9V, baterias de lítio, de carro, de nobreak.</td>
                        <td data-label="Riscos do Descarte Incorreto">Contaminação severa do solo e da água por mercúrio, cádmio, chumbo; risco de incêndio ou explosão.</td>
                        <td data-label="Benefícios da Reciclagem">Minimiza a contaminação ambiental; recuperação de metais que podem ser reutilizados em novas baterias.</td>
                    </tr>
                    <tr>
                        <td data-label="Nome do Material">Monitores e Televisores (LCD/LED)</td>
                        <td data-label="Descrição">Telas planas que contêm metais, plásticos e vidro.</td>
                        <td data-label="Observações para Descarte">Não tente desmontar. Procure pontos de coleta especializados devido ao tamanho e componentes.</td>
                        <td data-label="Exemplos de Itens">Monitores de computador LCD/LED, televisores de tela plana.</td>
                        <td data-label="Riscos do Descarte Incorreto">Liberação de mercúrio (em algumas telas mais antigas); descarte de vidro e plástico não reciclados.</td>
                        <td data-label="Benefícios da Reciclagem">Reaproveitamento de vidro, plásticos e metais; redução de resíduos em aterros.</td>
                    </tr>
                    <tr>
                        <td data-label="Nome do Material">Eletrodomésticos da Linha Branca</td>
                        <td data-label="Descrição">Grandes eletrodomésticos como geladeiras, máquinas de lavar, fogões.</td>
                        <td data-label="Observações para Descarte">Entre em contato com a prefeitura, empresas de reciclagem especializadas ou lojas que aceitam o item antigo na compra de um novo.</td>
                        <td data-label="Exemplos de Itens">Geladeiras, freezers, máquinas de lavar, secadoras, fogões, micro-ondas.</td>
                        <td data-label="Riscos do Descarte Incorreto">Liberação de gases poluentes (como CFCs de geladeiras antigas); grande volume de lixo.</td>
                        <td data-label="Benefícios da Reciclagem">Recuperação de aço, alumínio, cobre, plástico; tratamento de gases refrigerantes.</td>
                    </tr>
                    <tr>
                        <td data-label="Nome do Material">Pequenos Eletrodomésticos</td>
                        <td data-label="Descrição">Aparelhos eletrônicos de menor porte para uso doméstico ou pessoal.</td>
                        <td data-label="Observações para Descarte">Verifique se o fabricante ou a loja possui programa de coleta. Não descarte no lixo comum.</td>
                        <td data-label="Exemplos de Itens">Batedeiras, liquidificadores, ferros de passar, secadores de cabelo, aspiradores de pó, cafeteiras.</td>
                        <td data-label="Riscos do Descarte Incorreto">Desperdício de recursos; possível liberação de pequenas quantidades de substâncias tóxicas.</td>
                        <td data-label="Benefícios da Reciclagem">Recuperação de plásticos e metais; redução da necessidade de novas matérias-primas.</td>
                    </tr>
                </tbody>
            </table>
