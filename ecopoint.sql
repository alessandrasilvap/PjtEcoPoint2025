...
--
-- Host: 127.0.0.1
-- Tempo de geração: 25/05/2025 às 00:22
...
(1, 22, 'RETIPEL ', 'Rua Leandro Martins', 'Rio de Janeiro', 'Centro', 'Recebe e retira de acordo com o volume', '2025-05-04 20:45:45', 20080, 51, '', 'Rio de Janeiro', 'aprovado', -22.90116020, -43.18414110),
(2, 22, 'SABOR SAÚDE', 'Rua da Quitanda', 'Rio de Janeiro', 'Centro', 'Apenas recebe.', '2025-05-04 20:50:09', 20011, 21, '', 'Rio de Janeiro', 'aprovado', -22.90470390, -43.17639650),
(5, 22, 'SPOLETO URUGUAIANA', 'Rua Buenos Aires', 'Rio de Janeiro', 'Centro', '', '2025-05-04 20:56:27', 20061, 249, '', 'Rio de Janeiro', 'aprovado', -22.90513640, -43.18469550),
(6, 22, 'Colégio EDEM', 'Rua Gago Coutinho', 'Rio de Janeiro', 'Laranjeiras', '', '2025-05-04 20:59:59', 22221, 14, '', 'Rio de Janeiro', 'aprovado', -22.93126270, -43.18096420),
(8, 22, 'Loja Ahlma', 'Rua Carlos Gois', 'Rio de Janeiro', 'Leblon', 'Apenas recebe.', '2025-05-04 21:04:49', 22440, 208, '', 'Rio de Janeiro', 'aprovado', -22.98423560, -43.21987310),
(9, 22, 'Clube de Regatas Flamengo', 'Avenida Borges de Medeiros', 'Rio de Janeiro', 'Leblon', 'Apenas recebe.', '2025-05-04 21:05:55', 22430, 997, '', 'Rio de Janeiro', 'aprovado', -22.98432690, -43.21593270),
(10, 22, 'Shopping Rio Design Leblon', 'Avenida Ataulfo de Paiva', 'Rio de Janeiro', 'Leblon', 'Apenas recebe.', '2025-05-04 21:07:44', 22440, 270, '2º andar', 'Rio de Janeiro', 'aprovado', -22.98367300, -43.21695900),
(11, 22, 'T.T. Burguer', 'Avenida Ataulfo de Paiva', 'Rio de Janeiro', 'Leblon', 'Apenas recebe.', '2025-05-04 21:08:52', 22440, 1240, '', 'Rio de Janeiro', 'aprovado', -22.98595700, -43.22737300),
(12, 22, 'NEX COWORKING', 'Ladeira da Glória', 'Rio de Janeiro', 'Glória', 'Apenas recebe.', '2025-05-04 21:10:23', 22211, 26, 'Bloco 3', 'Rio de Janeiro', 'aprovado', -22.92201600, -43.17527430),
(13, 22, 'UNIRIO', 'Rua Voluntários da Pátria', 'Rio de Janeiro', 'Botafogo', '', '2025-05-04 21:11:40', 22270, 107, '', 'Rio de Janeiro', 'aprovado', -22.95206330, -43.18477470),
(14, 22, 'REDE ASTA', 'Rua Gago Coutinho', 'Rio de Janeiro', 'Laranjeiras', '', '2025-05-04 21:13:06', 22221, 66, 'Loja A', 'Rio de Janeiro', 'aprovado', -22.93142760, -43.18208630),
(15, 22, 'COOPAMA', 'Rua Miguel Ângelo', 'Rio de Janeiro', 'Posse', 'Recebe e coleta.', '2025-05-04 21:14:32', 25973, 385, '', 'Teresópolis', 'aprovado', -22.37218620, -42.99113300),
(16, 22, 'ACMR', 'Rua Itaigara', 'Rio de Janeiro', 'Coelho Neto', '', '2025-05-04 21:15:11', 21510, 77, '', 'Rio de Janeiro', 'aprovado', -22.83417490, -43.34902380),
(17, 22, 'COOPCAL', 'Avenida Itaóca', 'Rio de Janeiro', 'Inhaúma', '', '2025-05-04 21:15:59', 21061, 2353, '', 'Rio de Janeiro', 'aprovado', -22.87220010, -43.27692950),
(18, 22, 'COOPGALEÃO', 'Rua Macedo Costa', 'Rio de Janeiro', 'Inhaúma', '', '2025-05-04 21:16:44', 20765, 62, '', 'Rio de Janeiro', 'aprovado', -22.87367880, -43.28066670),
(19, 22, 'Maraca Hostel', 'Rua Ribeiro Guimarães', 'Rio de Janeiro', 'Vila Isabel', 'Apenas recebe.', '2025-05-04 21:17:24', 20541, 367, '', 'Rio de Janeiro', 'aprovado', -22.91947980, -43.23713910),
(20, 22, 'One On One Coworking', 'Rua Nossa Senhora de Lourdes', 'Rio de Janeiro', 'Grajaú', 'Apenas recebe.', '2025-05-04 21:18:20', 20540, 101, '', 'Rio de Janeiro', 'aprovado', -22.92110210, -43.25466060),
(21, 22, 'IJOKER no Shopping Bayside', 'Avenida das Américas', 'Rio de Janeiro', 'Barra da Tijuca', 'Apenas recebe.', '2025-05-04 21:20:47', 22640, 3120, 'loja 213', 'Rio de Janeiro', 'aprovado', -22.99940580, -43.34383850),
(22, 22, 'Shopping Rio Design Barra', 'Avenida das Américas', 'Rio de Janeiro', 'Barra da Tijuca', 'Apenas recebe.', '2025-05-04 21:21:33', 22793, 7777, '', 'Rio de Janeiro', 'aprovado', -23.00137360, -43.38588680),
(23, 22, 'ASSOCIAÇÃO BOSQUE MARAPENDI', 'Avenida Prefeito Dulcídio Cardoso', 'Rio de Janeiro', 'Barra da Tijuca', 'Apenas recebe.', '2025-05-04 21:22:16', 22620, 1250, '', 'Rio de Janeiro', 'aprovado', -23.00630520, -43.38880820),
(24, 22, 'T.T. BURGUER', 'Avenida Prefeito Dulcídio Cardoso', 'Rio de Janeiro', 'Barra da Tijuca', 'Apenas recebe.', '2025-05-04 21:22:58', 22621, 460, '', 'Rio de Janeiro', 'aprovado', -23.00785090, -43.41646440),
(26, 22, 'ESTACIONAMENTO TERREIRÃO', 'Avenida Guiomar Novais', 'Rio de Janeiro', 'Recreio dos Bandeirantes', 'Apenas recebe.', '2025-05-04 21:23:38', 22795, 400, '', 'Rio de Janeiro', 'aprovado', NULL, NULL),
(27, 22, 'Ecoponto Espaço Convivência Sustentável - INEA', 'Avenida Borges de Medeiros', 'Rio de Janeiro', 'Lagoa', 'Apenas recebe.', '2025-05-15 23:24:53', 22430, 1444, '', 'Rio de Janeiro', 'aprovado', -22.97072200, -43.21927000),
(28, 22, 'Paróquia São José', 'Avenida Borges de Medeiros', 'Rio de Janeiro', 'Lagoa', 'Apenas recebe.', '2025-05-15 23:24:53', 22470, 2735, '', 'Rio de Janeiro', 'aprovado', -22.97072200, -43.21927000),
(29, 22, '15º Ofício de Notas - Unidade Barra da Tijuca', 'Avenida das Américas', 'Rio de Janeiro', 'Barra da Tijuca', 'Apenas recebe.', '2025-05-15 23:24:53', 22640, 500, 'Bloco 11, Loja 106', 'Rio de Janeiro', 'aprovado', -23.00300000, -43.36500000),
(30, 22, 'Ecoponto Horto Municipal Carlos Guinle', 'Avenida Tobias Barreto', 'Rio de Janeiro', 'Quarenta Casas', 'Apenas recebe.', '2025-05-15 23:24:53', 25973, 21, '', 'Teresópolis', 'aprovado', -22.41670000, -42.97500000),
(31, 22, 'SESC Teresópolis', 'Avenida Delfim Moreira', 'Rio de Janeiro', 'Várzea', 'Apenas recebe.', '2025-05-15 23:24:53', 25963, 749, '', 'Teresópolis', 'aprovado', -22.41750000, -42.97500000),
(32, 22, 'COOPAMA', 'Rua Miguel Ângelo', 'Rio de Janeiro', 'Posse', 'Recebe e coleta.', '2025-05-04 21:14:32', 25973, 385, '', 'Teresópolis', 'aprovado', -22.37218620, -42.99113300),
(33, 22, 'SESC Teresópolis', 'Avenida Delfim Moreira', 'Rio de Janeiro', 'Várzea', 'Apenas recebe.', '2025-05-15 23:24:53', 25963, 749, '', 'Teresópolis', 'aprovado', -22.41750000, -42.97500000),
(34, 22, 'Ecoponto Horto Municipal Carlos Guinle', 'Avenida Tobias Barreto', 'Rio de Janeiro', 'Quarenta Casas', 'Apenas recebe.', '2025-05-15 23:24:53', 25973, 21, '', 'Teresópolis', 'aprovado', -22.41670000, -42.97500000),
(35, 22, 'Ponto de Coleta Centro Ambiental', 'Rua São Sebastião', 'Minas Gerais', 'Centro', 'Recebe resíduos recicláveis.', '2025-05-15 23:25:53', 30140, 123, '', 'Belo Horizonte', 'aprovado', -19.92083000, -43.93777800),
(36, 22, 'Reciclagem MG', 'Avenida Amazonas', 'Minas Gerais', 'Centro', 'Recebe papel, plástico e vidro.', '2025-05-15 23:26:15', 30180, 456, 'Sala 5', 'Belo Horizonte', 'aprovado', -19.92450000, -43.93830000),
(37, 22, 'Ponto Verde', 'Rua XV de Novembro', 'São Paulo', 'Centro', 'Recebe apenas vidros.', '2025-05-15 23:26:50', 1001, 789, '', 'São Paulo', 'aprovado', -23.55052000, -46.63330800),
(38, 22, 'Coleta Seletiva SP', 'Avenida Paulista', 'São Paulo', 'Bela Vista', 'Recebe papel, plástico, metal.', '2025-05-15 23:27:20', 1311, 1000, 'Loja 10', 'São Paulo', 'aprovado', -23.56141400, -46.65588100),
(39, 22, 'Centro de Reciclagem Brasília', 'Setor Comercial Sul', 'Distrito Federal', 'Centro', 'Recebe todos os tipos de material reciclável.', '2025-05-15 23:35:00', 70070, 500, '', 'Brasília', 'aprovado', -15.79388900, -47.88277800),
(40, 22, 'Ponto Verde Curitiba', 'Rua XV de Novembro', 'Paraná', 'Centro', 'Recebe papel e plástico.', '2025-05-15 23:36:10', 80020, 1100, '', 'Curitiba', 'aprovado', -25.42895400, -49.26713700),
(41, 22, 'EcoPonto Porto Alegre', 'Avenida Borges de Medeiros', 'Rio Grande do Sul', 'Centro', 'Recebe vidro e metal.', '2025-05-15 23:37:20', 90020, 250, '', 'Porto Alegre', 'aprovado', -30.03464700, -51.21765800),
(42, 22, 'Coleta Reciclável Salvador', 'Avenida Sete de Setembro', 'Bahia', 'Centro', 'Apenas recebe plástico.', '2025-05-15 23:38:15', 40020, 700, '', 'Salvador', 'aprovado', -12.97139900, -38.50130500),
(43, 22, 'Reciclagem Fortaleza', 'Rua Major Facundo', 'Ceará', 'Centro', 'Recebe papel e vidro.', '2025-05-15 23:39:00', 60020, 890, '', 'Fortaleza', 'aprovado', -3.71722000, -38.54337000),
(44, 22, 'EcoPonto Manaus', 'Avenida Djalma Batista', 'Amazonas', 'Centro', 'Recebe papel, plástico e metal.', '2025-05-15 23:40:00', 69020, 1200, '', 'Manaus', 'aprovado', -3.11902800, -60.02173100),
(45, 22, 'Ponto de Coleta Recife', 'Rua do Bom Jesus', 'Pernambuco', 'Recife Antigo', 'Recebe todos os materiais recicláveis.', '2025-05-15 23:41:00', 50030, 320, '', 'Recife', 'aprovado', -8.04756200, -34.87700300),
(46, 22, 'Coleta Seletiva Belém', 'Avenida Almirante Barroso', 'Pará', 'Marco', 'Apenas recebe plástico.', '2025-05-15 23:42:00', 66020, 600, '', 'Belém', 'aprovado', -1.45583300, -48.49017900),
...
(22, 'Alessandra Cristina da Silva Pereira', 'alessandracris393@gmail.com', '275.069.120-66', 'ale_pe', '$2y$10$xmywUw7ixexC9jE5.cTKeOhxo0YASFkbaLeuBDjKCRDnvH76c/cwy', 'Rua Castro Alves', 'Rio de Janeiro', 'Méier', 20775, 158, 'Casa 08', 0, '2004-07-07', '2025-05-15 23:00:42');
